            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption text-start slide-in-left">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="gal.jsp" class="btn btn-primary btn-lg rounded-0 px-4 animate-pulse">Shop Now</a>
                        <a href="virtual.jsp" class="btn btn-outline-light btn-lg rounded-0 px-4">Virtual Tour</a>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption text-center slide-in-bottom">
                    ...
                    <div class="d-flex gap-2 justify-content-center flex-wrap">
                        <a href="gal.jsp" class="btn btn-primary btn-lg rounded-0 px-4 animate-pulse">Bedroom Sets</a>
                        <a href="#design-ideas" class="btn btn-outline-light btn-lg rounded-0 px-4">Design Ideas</a>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption text-end slide-in-right">
                    ...
                    <div class="d-flex gap-2 justify-content-end flex-wrap">
                        <a href="gal.jsp" class="btn btn-primary btn-lg rounded-0 px-4 animate-pulse">Dining Collections</a>
                ...
                <div class="category-card position-relative overflow-hidden hover-scale">
                    ...
                    <div class="category-overlay d-flex align-items-center justify-content-center">
                        <div class="text-center">
                            ...
                            <a href="login.jsp" class="btn btn-outline-light btn-sm mt-3 rounded-0">EXPLORE</a>
                        </div>
                    </div>
                </div>
            </div>
